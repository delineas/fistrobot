module.exports = function(controller, menu) {
  ...
  controller.hears('ayuda','message_received', function(bot, message) {
    ...
    bot_reply(message,'Las frases están extraídas de esta genial colección del blog <a href="http://chiquitodelacalzada.blogspot.com.es/p/frases-miticas.html" target="_blank">Chiquito de la Calzada</a>');

    bot_reply(message,'Si en algún momento te pierdes teclea <strong>ayuda</strong> o <strong>inicio</strong>');

    bot_reply(message,'¡Hasta luego Lucas!');
